...
@section('title', 'Crear Promoción - Salon Anita')
...
@section('header')
    <div class="flex items-center space-x-4">
        ...
        <div>
            <h2 class="text-3xl font-extrabold text-gray-800 tracking-tight">Crear Promoción</h2>
            <p class="text-gray-500 font-medium">Define un nuevo descuento para tus clientes.</p>
        </div>
    </div>
@endsection
        ...
        <form action="{{ route('promociones.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="nombre" value="{{ old('nombre') }}" required placeholder="Ej. Descuento de Primavera, Black Friday, etc."
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="descripcion" rows="3" placeholder="Detalles de los términos de la promoción..."
                              class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-rose-200 focus:border-rose-400 transition-all text-gray-700 font-medium">{{ old('descripcion') }}</textarea>
                </div>

                <div>
                    <label class="block text-sm font-bold text-gray-700 mb-2">Porcentaje de Descuento (%) <span class="text-rose-500">*</span></label>
                    <input type="number" name="descuento_porcentaje" value="{{ old('descuento_porcentaje') }}" required min="1" max="100" placeholder="Ej. 20"
                           class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-rose-200 focus:border-rose-400 transition-all text-gray-700 font-medium">
                </div>
                ...
                <div class="flex items-end pb-3">
                    <label class="relative inline-flex items-center cursor-pointer">
                        ...
                        <span class="ml-3 text-sm font-bold text-gray-700">Activa Inmediatamente</span>
                    </label>
                </div>
                ...
                <div class="border-t border-rose-50 pt-6 md:col-span-2">
                    ...
                    <p class="text-xs text-gray-400 mb-4">Si no seleccionas ninguno, se guardará como promoción general informativa.</p>
                </div>
