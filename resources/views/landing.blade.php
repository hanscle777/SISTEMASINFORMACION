...
<head>
    ...
    <title>Salón de Belleza Anita - Estilo y Bienestar Premium</title>
    ...
    <header class="glass-nav fixed top-0 w-full z-40 border-b border-stone-100 shadow-sm transition-all duration-300">
        <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <nav class="hidden md:flex items-center space-x-8 text-sm font-bold text-stone-600">
                <a href="#inicio" class="hover:text-amber-600 transition-colors">Inicio</a>
                @if(!$promociones->isEmpty())
                    <a href="#promociones" class="hover:text-amber-600 transition-colors">Promociones</a>
                @endif
                <a href="#servicios" class="hover:text-amber-600 transition-colors">Servicios</a>
                <a href="#productos" class="hover:text-amber-600 transition-colors">Tienda</a>
                @auth
                    <a href="#portal" class="text-amber-600 hover:text-amber-700 flex items-center space-x-1">
