...
@section('title', 'Nuevo Usuario - Salón de Belleza Anita')

@section('header')
<div class="mb-8">
    <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Nuevo Usuario</h1>
    <p class="text-gray-500 font-medium">Registra un nuevo miembro en el sistema.</p>
</div>
@endsection
