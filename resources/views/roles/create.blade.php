...
@section('title', 'Definir Nuevo Rol - Salón de Belleza Anita')

@section('header')
<div class="mb-8">
    <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Definir Nuevo Rol</h1>
    <p class="text-gray-500 font-medium">Crea un nuevo nivel de acceso para el sistema.</p>
</div>
@endsection
    ...
    <div class="bg-gray-50 p-10 rounded-[2.5rem] border border-gray-100">
        <form action="{{ route('roles.store') }}" method="POST">
            ...
            <div class="space-y-8">
                ...
                <div>
                    <h2 class="text-lg font-black text-gray-800 mb-6 border-b border-gray-100 pb-4">Asignación de Permisos</h2>
