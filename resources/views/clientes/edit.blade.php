...
@section('title', 'Editar Cliente - Salon Anita')
...
@section('header')
    <div class="flex items-center space-x-4">
        ...
        <div>
            <h2 class="text-3xl font-extrabold text-gray-800 tracking-tight">Editar Cliente</h2>
            <p class="text-gray-500 font-medium">Modifica los datos del cliente.</p>
        </div>
    </div>
@endsection
